package com.dengwn.code.leetcode.solution.t3.h1.d6;
...
public class Solution3165 {
    ...
    public static void main(String[] args) {
        Solution3165 solution3165 = new Solution3165();
        int[] nums = {3, 5, 9};
        int[][] queries = {{1, -2}, {0, -3}};
        System.out.println(solution3165.maximumSumSubsequence(nums, queries));
    }
